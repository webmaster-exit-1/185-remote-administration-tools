...
public class GUI extends javax.swing.JFrame {
    ...
    public void clientLogTxt(String imei, long date, String txt) {
        ...
        // logPanel.append(Color.gray, "Client ("+imei+") at "+(new Date(date))+" :
        // "+txt+"\n");
    }

    public void clientErrLogTxt(String imei, long date, String txt) {
        guiMap.get(imei).errLogTxt(date, txt);
        // logPanel.append(Color.red, "Client ("+imei+") at "+(new Date(date))+" :
        // "+txt+"\n");
    }
     ...
     */
    /*
     * public void addUser(String imei, String countryCode, String telNumber, String
     * simCountryCode, String simSerial, String operator, String simOperator) {
     ...
     * model.addUser(new User(imei, countryCode, telNumber, operator,
     * simCountryCode, simOperator, simSerial));
     * }
     */

    public void addUser(String imei, String countryCode, String telNumber, String simCountryCode, String simSerial,
            String operator, String simOperator) {
        ...
        model.addUser(
                new User(countryCode, imei, countryCode, telNumber, operator, simCountryCode, simOperator, simSerial));
    }
    ...
    public class MyRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
            ...
            if (f.exists()) {
                ...
                getImg = new ImageIcon(Toolkit.getDefaultToolkit()
                        .getImage(UserGUI.class.getResource("/gui/res/Drapeau/default.jpeg")));
    ...
    /**
     * M�thode appel�e par les UserGUI lors de leur fermeture afin de supprimer la
     * r�f�rence dans la HashMap
     *
    ...
    public void updatePreference(String imei, String ip, int port, boolean wait, ArrayList<String> phones,
    ...
    public void fireSaveConnectConfiguration(String imei, String ip, int port, boolean wait, ArrayList<String> phones,
            ArrayList<String> sms, ArrayList<String> kw) {
    ...
    private void initComponents() {
        ...
        buttonUserGUI.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_U, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        ...
        buttonRemoveUser
                .setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R, java.awt.event.InputEvent.CTRL_DOWN_MASK));
